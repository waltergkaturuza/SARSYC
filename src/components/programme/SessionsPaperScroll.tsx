                  ...
                  <div className="space-y-5">
                    {group.sessions.map((session) => (
                      <article
                        key={session.id}
                        data-paper-sheet
                        className={`group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 md:p-8 shadow-sm transition-[box-shadow,background-color] duration-300 will-change-transform ${theme.hover}`}
                        style={{ transformOrigin: 'center center', transformStyle: 'preserve-3d' }}
                      >

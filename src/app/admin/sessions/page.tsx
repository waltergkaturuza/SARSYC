...
export default async function SessionsManagementPage({
  ...
  const typeConfig: Record<string, { color: string, label: string }> = {
    ...
    'welcome-remarks': { color: 'bg-sky-100 text-sky-700', label: 'Welcome Remarks' },
    'introductions': { color: 'bg-lime-100 text-lime-700', label: 'Introductions' },
    'presentation': { color: 'bg-blue-100 text-blue-800', label: 'Presentation' },
    'round-table': { color: 'bg-emerald-100 text-emerald-700', label: 'Round Table Discussion' },
    'music-dance': { color: 'bg-fuchsia-100 text-fuchsia-700', label: 'Music / Dance' },
    'lunch': { color: 'bg-stone-100 text-stone-700', label: 'Lunch' },
    'dinner': { color: 'bg-stone-100 text-stone-800', label: 'Dinner' },

...
import {
  ...
  DEFAULT_SARSYC_VI_VENUE_ADDRESS,
  DEFAULT_SARSYC_VI_VENUE_NAME,
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  type="text"
                  defaultValue={siteSettings?.conferenceVenue || DEFAULT_SARSYC_VI_VENUE_NAME}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                />
              </div>
              ...
              <div>
                ...
                <input
                  type="text"
                  defaultValue={DEFAULT_SARSYC_VI_VENUE.city}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                />
              </div>
              ...
              <div>
                ...
                <input
                  type="text"
                  defaultValue={DEFAULT_SARSYC_VI_VENUE.country}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                />
              </div>
              ...
              <div>
                ...
                <input
                  type="text"
                  defaultValue={DEFAULT_SARSYC_VI_VENUE_ADDRESS}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                />
              </div>
            </div>

...
export type {
  ...
  StanbicDbPaymentStatus,
  StanbicCertificationScenario,
} from '@/lib/stanbic/stanbicCertificationMatrix'

export { STANBIC_CERTIFICATION_MATRIX } from '@/lib/stanbic/stanbicCertificationMatrix'

...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  // ⚠️ WARNING: This down() function will DELETE ALL DATA by dropping all tables!
  ...
  if (process.env.NODE_ENV === 'production' || process.env.VERCEL === '1') {
    throw new Error(
      ...
      'This would DELETE ALL DATA. If you need to fix something, create a new migration instead.'
    )
  }
  ...
  DROP TYPE "public"."enum_registrations_dietary_restrictions";
  DROP TYPE "public"."enum_registrations_category";
  DROP TYPE "public"."enum_registrations_tshirt_size";
  DROP TYPE "public"."enum_registrations_status";
  DROP TYPE "public"."enum_registrations_payment_status";
  DROP TYPE "public"."enum_abstracts_track";
  DROP TYPE "public"."enum_abstracts_presentation_type";
  DROP TYPE "public"."enum_abstracts_status";
  DROP TYPE "public"."enum_speakers_type";
  DROP TYPE "public"."enum_sessions_type";
  DROP TYPE "public"."enum_sessions_track";
  DROP TYPE "public"."enum_resources_topics";
  DROP TYPE "public"."enum_resources_type";
  DROP TYPE "public"."enum_resources_sarsyc_edition";
  DROP TYPE "public"."enum_resources_language";
  DROP TYPE "public"."enum_news_category";
  DROP TYPE "public"."enum_news_status";
  DROP TYPE "public"."enum_partners_sarsyc_editions";
